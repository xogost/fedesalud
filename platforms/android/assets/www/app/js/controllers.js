...
ModuleMyApp.controller('instrumentounoController', ['$scope', '$routeParams', function($scope, $routeParams) {
        ...
        $scope.guardar = function(urlPagina) {
            ...
            var arrayNameRadios = [];
			//jQuery(".textinfo").addClass("text-info");
        ...
        $scope.querySaveEncuesta = function(tx) {
            ...
            jQuery('.form-container input[type=checkbox]:checked').each(function() {
                arrayData[jQuery(this).attr("id")] = jQuery(this).val();
            });
